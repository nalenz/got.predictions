...
dataPredict = readFormattedBinaryMLFile("v2-data-predict")
dataTrain = readFormattedBinaryMLFile("v2-data-train")
labelsTrain = readFormattedBinaryMLFile("v2-labels-train")
