...
const infile = path.resolve(__dirname, '../predictors-bayesian/predictor-bayesean-show/show_predictor_output.json');
...
reformat(() => {
  console.log('Postprocessing show predictions complete!');
});
